 ...
 * @return A Map where the key is the year and the value is a List of daily power peak with temperature entries for that year.
 */
 ...
 *
 * @param yearData The list of daily power peak with temperature entries for a specific year.
 * @return A tuple containing the maximum power peak entry and the minimum temperature entry for the specified year.
 */
